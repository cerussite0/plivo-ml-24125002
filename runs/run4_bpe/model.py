"""Run 4 — BPE tokenizer + Run 3 architecture.
BPE with 512 merges (vocab 768) compresses Hindi text ~3x.
Same SwiGLU + RMSNorm architecture as Run 3 but with BPE vocab.
"""
import math
import torch
...
class Config:
    vocab_size = 768      # BPE: 256 bytes + 512 merges
    block_size = 256
    n_layer = 4
    n_head = 6
    n_embd = 192
